    ...
    <div class="top-header">
        <div class="container">
            ...
            <div id="user-info-top" class="user-info pull-right">
                ...
                <a class="current-open"  aria-haspopup="true" aria-expanded="false" href="<?php echo base_url();?>user/admin"><span>Back</span></a>
                </div>
            </div>
        </div>
		</div>
			   ...
			   <form action="<?php echo base_url();?>user/updateProfile1/" method="post">
				 ...
				 foreach ($data as $row){
					 ?>
                        ...
                        <button type="submit" class="button" href="<?php echo base_url();?>user/updateProfile1">
