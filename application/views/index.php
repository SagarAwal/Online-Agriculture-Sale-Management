    ...
    <div class="top-header">
        <div class="container">
            ...
            <div id="user-info-top" class="user-info pull-right">
                <div class="dropdown">
                    <a class="current-open"  aria-haspopup="true" aria-expanded="false" href="<?php echo site_url('welcome/login')?>"><span>Login</span></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="content-page">
    <div class="tab-panel active" id="tab-4">
				...
				<?php echo anchor("welcome/login/{}", 'Add To Cart'); ?>
											</div>
                                        </div>
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#"><?php echo $row->vegetable_name; ?></a></h5>
                                            <div class="content_price">
                                                <span class="price product-price"><?php echo $row->unit_cost; ?></span>
                                            </div>
